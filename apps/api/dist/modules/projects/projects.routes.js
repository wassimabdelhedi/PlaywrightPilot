...
import { createProjectSchema, listProjectsQuerySchema, projectIdParamSchema, updateProjectSchema, } from "./projects.schema.js";
...
projectsRouter.get("/:id", validate(projectIdParamSchema, "params"), asyncHandler(controller.getById));
projectsRouter.patch("/:id", validate(projectIdParamSchema, "params"), validate(updateProjectSchema, "body"), asyncHandler(controller.update));
projectsRouter.delete("/:id", validate(projectIdParamSchema, "params"), asyncHandler(controller.remove));
