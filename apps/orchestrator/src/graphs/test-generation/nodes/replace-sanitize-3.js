...
const buildFns = unction buildSystemPrompt(state: TestGenerationStateType): string {
...
code = code.replace(/export async function generatePlan/, buildFns + 'export async function generatePlan');
